...
#x2 = erode(filters=1, kernel_size=(3,3),strides=(1,1),operation='m')(inputs)
#x = Subtract()([x1,x2])
...
x4 = adapt(filters=1, kernel_size=(3,3), strides=(1,1), operation='m')(x3)
...
#x4 = erode(filters=1, kernel_size=(3,3),strides=(1,1),operation='m')(x1)
M = Model(inputs=inputs,outputs=x4)
...
predict2 = np.reshape(M.get_weights()[0], (3,3))
...
M.fit(x_train, y_train, batch_size = 64, epochs=1, verbose=1)
