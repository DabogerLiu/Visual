...
def grad_cam(input_model, image, cls, layer_name):
    ...
    grads = K.gradients(grads, conv_output)
    grads = K.gradients(grads, conv_output)
    grads = K.gradients(grads, conv_output)[0]
...
gradcam, gb, guided_gradcam = compute_saliency(model, guided_model, 'boxer.jpg', layer_name='block5_conv3',
                                               cls=242, visualize=True, save=True)
gradcam, gb, guided_gradcam = compute_saliency(model, guided_model, 'cat.png', layer_name='block5_conv3',
                                               cls=281, visualize=True, save=False)
